...
public class PlayerImpl extends PthPlayer {
    ...
    public PlayerImpl(BukkitPthData pthData, Player mcPlayer, double x, double y) {
        super(pthData);
        this.x = x;
        this.y = y;
        ...
        stgPlayerSpawn.getDoubles().write(0, this.x)
                .write(1, this.x)
                .write(2, this.y);
        try {
    ...
    public void tick() {
        ...
        if (player != null) {
            ...
            move.getDoubles().write(0, pthData.x).write(1, this.x).write(2, this.y);
